// VK API сейчас дает код любого виджета (стена\сообщения сообщества и тд) напрямую для подключения на своей странице по любым параметрам.
        ...
        if (!e.fastXDM) {
            ...
            e.fastXDM = {
                ...
                Client: function(i, n) {
                    ...
                    this.key = window.name.substr(3), this.caller = window.parent, o[this.key] || (o[this.key] = {}), this.methods["%proxy%"] = function(e, t) {
...
VK.UI || (VK.UI = {
    ...
    // Находим функцию, генерирующую в рамку стену постов сообщества
